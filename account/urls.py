...
from .forms_auth import UserLoginForm
from django.contrib.auth.decorators import login_required
from .forms_auth import PwdResetForm, PwdResetConfirmForm
...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='account/registration/login.html',
                                                redirect_authenticated_user=True, next_page='/account/dashboard/', form_class=UserLoginForm), name='login'),
    ...
    path('password_reset_confirm/<uidb64>/<token>', auth_views.PasswordResetConfirmView.as_view(template_name='account/user/password_reset_confirm.html', success_url='/account/password_reset_complete/', form_class=PwdResetConfirmForm),
